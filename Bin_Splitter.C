...
void Bin_Splitter()
{
  ...
  else
  {
    ...
    printf("export PT_DIV_9=%f\n",7.0);
    printf("export PT_DIV_10=%f\n",10.0);
    printf("export PT_DIV_11=%f\n",pt_high);
    //*/
    /*
    // low vs. high pT
    pt_bins=2;
  ...
  else
  {
    ...
    printf("export EN_DIV_8=%f\n",50);
    printf("export EN_DIV_9=%f\n",70);
    printf("export EN_DIV_10=%f\n",en_high);
    //*/
    /*
    // for pt_dependence in 3 different energy bins
    en_bins=3;
    printf("export EN_BINS=%d\n",en_bins);
    printf("export EN_DIV_0=%f\n",en_low);
    printf("export EN_DIV_1=%f\n",50);
